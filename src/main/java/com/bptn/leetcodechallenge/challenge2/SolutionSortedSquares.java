...
public class SolutionSortedSquares {
	...
	public int[] sortedSquares(int[] nums) {
		...
		return Arrays.stream(nums)
				// using the mapping function with lambda to square each element in the list to
				// return squared list
				.map((x) -> x * x)
	...
	public static void main(String[] args) {
		...
		// testing with one of the example test on leetcode to confirm correctness of
		// code
		int[] nums = { -4, -1, 0, 3, 10 };
